...
<ul class="site-sidebar">
    <!-- ▼ここから検索ボックス -->
    <li class="sidebar-contents-wrapper">
    ...
    ?>
        <li class="sidebar-contents-wrapper">
            ...
            <div class="sidebar-margin-md widget widget_block widget_recent_entries">
    ...
    <li class="sidebar-contents-wrapper">
        ...
        <div class="sidebar-margin-md widget widget_block widget_categories">
            <?php
                global $post_types;
